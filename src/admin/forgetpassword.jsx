...
function Forgetpassword() {
  ...
  const sendOTP = async () => {
    ...
    try {
      const res = await axios.post("https://menswear-backend-770o.onrender.com/api/generate-otp ", {
        phonenumber,
      });
...
const verifyOTP = async () => {
  ...
  try {
    const res = await axios.post("https://menswear-backend-770o.onrender.com/api/verify-otp", {
      phonenumber,
      otp,
    });
