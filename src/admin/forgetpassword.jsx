...
function Forgetpassword() {
  ...
  const sendOTP = async () => {
    ...
    try {
      const res = await axios.post("https://menswear-backend-production.up.railway.app/api/generate-otp ", {
        phonenumber,
      });
...
const verifyOTP = async () => {
  ...
  try {
    const res = await axios.post("https://menswear-backend-production.up.railway.app/api/verify-otp", {
      phonenumber,
      otp,
    });
